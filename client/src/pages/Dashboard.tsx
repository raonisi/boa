  ...
  return (
    <section className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground mt-1">권한 범위 안의 일정, 알림, 장기 미관리 고객, 이번 달 신규 계약 현황입니다.</p>
      </div>
      <div className="grid grid-cols-2 gap-2 sm:gap-3 md:grid-cols-4">
        ...
        <StatCard title="이번 달 신규 계약" value={isLoading ? "-" : cards?.monthlyContractCount} icon={FileText} color="text-green-600" />
